...
import { fetchbreakingblogs, fetchtajasamachar } from "../_service_Api/ServiceAPI";
...
const BreakingNew = () => {
  ...
  const getbreaking = async () => {
    const data = await fetchbreakingblogs()
    const tajasamachardata = await fetchtajasamachar()

                        ...
                        <table className="table table-striped table-dark ">
                            ...
                            <tbody>
                                <tr >
                                    ...
                                    <th scope="row">
                                        <h5 className="text-left" >Account Name / खाता नाम</h5>
                                    </th>
                                    <td >
                                        <h5 className=" text-left">Third Eye World News (Hindi)</h5>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">
                                        <h5 className=" text-left">Bank Name / बैंक नाम</h5>
                                    </th>
                                    <td>
                                        <h5 className=" text-left">ICICI BANK</h5>
                                    </td>

                                </tr>
                                <tr>
                                    <th scope="row">
                                        <h5 className="mt-0 text-left">Account Number/खाता नंबर</h5>
                                    </th>
                                    <td>
                                        <h5 className="mt-0 text-left">000705029296</h5>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">
                                        <h5 className="mt-0 text-left">IFS Code/आईएफएस कोड</h5>

                                    </th>
                                    <td>
                                        <h5 className="mt-0 text-left">ICIC0000007</h5>

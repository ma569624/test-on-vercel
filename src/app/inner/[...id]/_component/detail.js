...
const Detail = (props) => {
    ...
    const getblogs = async () => {
        const blogs = await fetch(`https://new-backend-server-production.up.railway.app/api/blogs?page=${currentPage}&limit=${limit}&Category=${data.Category}`)
                                ...
                                <div ref={componentRef}>
                                    ...
                                    <div className="post-content">
                                        <div className="postbox__text-meta pb-2 mb-2" >
                                            <ul>
                                                <li>
                                                    <i className="far fa-user-circle" style={{ fontSize: 12, color: '#000' }}></i>
                                                    <span className="pr-2" style={{ fontSize: 12, color: '#000' }}>आकाश श्रीवास्तव</span>
                                                </li>
                                                <li>
                                                    <i className="fas fa-calendar-alt " style={{ fontSize: 12, color: '#000' }}></i>
                                                    <span className="pr-2" style={{ fontSize: 12, color: '#000' }}>16 feb 2024</span>
                                                </li>
                                                <li><i className="far fa-clock" style={{ fontSize: 12, color: '#000' }}></i> <span className="pr-2" style={{ fontSize: 12, color: '#000' }}>12:03:00</span></li>
                                                <li><i className="far fa-clock" style={{ fontSize: 12, color: '#000' }}></i> <span className="pr-2" style={{ fontSize: 12, color: '#000' }}>Delhi</span></li>
                                                <li>
                                                    <i className="far fa-comment" style={{ fontSize: 12, color: '#000' }}></i>

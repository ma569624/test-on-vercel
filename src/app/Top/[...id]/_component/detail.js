...
import { fetchCategory, fetchblogs } from "@/app/_service_Api/ServiceAPI";
...
const Detail = (props) => {
  ...
  const getblogs = async () => {
    ...
    const blogdata = await fetchblogs(currentPage,limit, data.Category);
  ...
  useEffect(() => {
    const getsection = async () => {
      if (data.Category) {
        ...
        const sectiondata = fetchCategory(data.Category)
